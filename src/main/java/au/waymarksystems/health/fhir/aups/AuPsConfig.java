...
public class AuPsConfig {
	...
	public AuPatientSummaryGeneratorProvider auPsOperationProvider(IIpsGeneratorSvc theIpsGeneratorSvc) {
		return new AuPatientSummaryGeneratorProvider(theIpsGeneratorSvc);
	}
}
