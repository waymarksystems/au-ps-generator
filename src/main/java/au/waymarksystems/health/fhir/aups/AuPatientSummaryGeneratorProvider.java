...
public class AuPatientSummaryGeneratorProvider extends IpsOperationProvider {
    ...
    private final AuPatientSummaryGeneratorSvc myAuPatientSummaryGeneratorSvc;

    @Autowired
    public AuPatientSummaryGeneratorProvider(
            IIpsGeneratorSvc theIpsGeneratorSvc, AuPatientSummaryGeneratorSvc theAuPatientSummaryGeneratorSvc) {
        super(theIpsGeneratorSvc);
        myAuPatientSummaryGeneratorSvc = theAuPatientSummaryGeneratorSvc;
    }
