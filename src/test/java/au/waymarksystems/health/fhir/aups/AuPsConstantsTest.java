...
class AuPsConstantsTest {
	...
	@Test
	void observationProfilesMatchPublishedIgIds() {
		assertThat(AuPsConstants.AU_PS_SMOKING_STATUS_PROFILE)
				.isEqualTo("http://hl7.org.au/fhir/ps/StructureDefinition/au-ps-smokingstatus");
		assertThat(AuPsConstants.AU_PS_PATHOLOGY_RESULT_PROFILE)
				.isEqualTo("http://hl7.org.au/fhir/ps/StructureDefinition/au-ps-diagnosticresult-path");
	}
	...
	@Test
	void observationIsNotInUnambiguousMap() {
	...
	@Test
	void sectionCodesMatchAuPsComposition() {
		assertThat(AuPsConstants.SECTION_CODE_ALERTS).isEqualTo("104605-1");
		assertThat(AuPsConstants.SECTION_CODE_PATIENT_STORY).isEqualTo("81338-6");
		assertThat(AuPsConstants.LOINC_SMOKING_STATUS).isEqualTo("72166-2");
	}
}
